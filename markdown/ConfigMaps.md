...
- Criando ConfigMaps a partir de diretórios 
  ...
  ```bash
   ...
   wget https://kubernetes.io/examples/configmap/game.properties\
    -O configure-pod-container/configmap/game.properties
   wget https://kubernetes.io/examples/configmap/ui.properties\
    -O configure-pod-container/configmap/ui.properties
...
- Criando ConfigMaps a partir de arquivos
  ...
  wget https://kubernetes.io/examples/configmap/game-env-file.properties\
   -O configure-pod-container/configmap/game-env-   file.properties
